...
const CORE_ASSET = "SEER"; // Setting this to BTS to prevent loading issues when used with BTS chain which is the most usual case currently
...
class SettingsStore {
    constructor() {
        ...
        this.defaultSettings = Immutable.Map({
            ...
            faucet_address3: settingsAPIs.DEFAULT_FAUCET3,
            unit: CORE_ASSET,
            showSettles: false,
        ...
        this.mainnet_faucet3 = ss.get("mainnet_faucet", settingsAPIs.DEFAULT_FAUCET3);
