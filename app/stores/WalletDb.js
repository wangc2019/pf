...
import {Apis, ChainConfig} from "seerjs-ws";
...
class WalletDb extends BaseStore {
    ...
    constructor() {
        ...
        // this.state = { wallet: {chain_id:'da68a9c5f2fd9ed48e626ea301db1c77505523884ba0dd409e779246c6ea26cf'}, saving_keys: false } //test
   ...
   // yin
    ...
    return Promise.all([
        ...
        return tr.get_potential_signatures().then( ({pubkeys, addys})=> {
          pubkeys.length>1?pubkey=pubkeys[1]:pubkey=pubkeys[0];
          return tr.get_required_signatures([pubkey]).then( required_pubkeys => {
