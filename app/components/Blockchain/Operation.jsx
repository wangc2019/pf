    ...
    render() {
        ...
        switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
            ...
            case "override_transfer":
                ...
                break;
            case "witness_create_collateral":
                column = (
                    <TranslateWithLinks
                        string="operation.witness_create_collateral"
                        keys={[
                            {type: "account", value: op[1].witness_account, arg: "witness_account"},
                            {type: "amount", value: {amount: op[1].amount, asset_id: "1.3.0"}, arg: "amount"}
                        ]}
                    />
                );
            ...
            case "witness_cancel_collateral":
            column = (
                <TranslateWithLinks
                    string="operation.witness_cancel_collateral"
                    keys={[
                            {type: "account", value: op[1].witness_account, arg: "witness_account"},
                            {type: "string", value: op[1].collateral_id, arg: "collateral_id"}
                        ]}
                />
            );
            break;

            case "witness_claim_collateral":
            column = (
                <TranslateWithLinks
                    string="operation.witness_claim_collateral"
                    keys={[
                        {type: "account", value: op[1].witness_account, arg: "witness_account"},
                        {type: "amount", value: this.props.result[1], arg: "balance"}
                    ]}
                />
            )
            break;
            ...
            case "oracle_create":
                column = (
                    <TranslateWithLinks
                        ...
                        keys={[
                            {type: "account", value: op[1].issuer, arg: "issuer"},
                            {type: "amount", value: {amount: op[1].guaranty, asset_id: "1.3.0"}, arg: "guaranty"}
                        ]}
                    />
                );
                break;
            ...
            case "oracle_update":
                column = (
                    <TranslateWithLinks
                        string="operation.oracle_update"
                        keys={[
                            {type: "account", value: op[1].issuer, arg: "issuer"}
                        ]}
                    />
            ...
            case "seer_room_stop_participating":
                column = (
                    <TranslateWithLinks
                        string="operation.seer_room_stop_participating"
                        keys={[
                            {type: "account", value: op[1].issuer, arg: "issuer"},
                            {type: "string", value: op[1].room, arg: "room"}
                        ]}
            ...
            case "seer_room_final":
            {
                let balance = 0 ;
                for (var x of this.props.result[1].deltas) { // 遍历Array
                    if (x[0] == this.props.current)
                    {
                        balance = x[1];
                        break;
                    }
            ...
            case "seer_room_close":
                column = (
                    <TranslateWithLinks
                        string="operation.seer_room_close"
                        keys={[
                            {type: "account", value: op[1].issuer, arg: "issuer"},
                            {type: "string", value: op[1].room, arg: "room"}
                        ]}
            ...
            case "seer_house_create":
                column = (
                    <TranslateWithLinks
                        string="operation.seer_house_create"
                        keys={[
                            {type: "account", value: op[1].issuer, arg: "issuer"},
                            {type: "amount", value: {amount: op[1].guaranty, asset_id: "1.3.0"}, arg: "guaranty"}
                        ]}
            ...
            case "seer_house_update":
                column = (
                    <TranslateWithLinks
                        string="operation.seer_house_update"
                        keys={[
                            {type: "account", value: op[1].issuer, arg: "issuer"},
                            {type: "string", value: op[1].house, arg: "house"}
                        ]}
                    />
                );
                break;

            case "asset_create_market":
                column = (
                    <TranslateWithLinks
                        string="operation.asset_create_market"
                        keys={[
                            {type: "account", value: op[1].issuer, arg: "issuer"},
                            {type: "asset", value: op[1].asset_id, arg: "asset_id"},
                            {type: "string", value: op[1].sequence, arg: "sequence"},
                            {type: "asset", value: op[1].asset_id, arg: "asset_id"},
                            {type: "asset", value: op[1].target, arg: "target"}
                        ]}
                    />
                );
                break;
