      ...
      <div className="recharge">
        ...
        <div className="content">
          <div>
            ...
            {/*<p style={{fontWeight:400}}>将您在交易所或以太钱包的PFC自动兑换至主网（Powerfans）钱包。系统已自动为您的账号分配了一个ETH地址。将交易所或以太钱包中的PFC代币转入该地址，Seer主网（Powerfans）帐号即可自动获得等额PFC，第一次建议小额转账先试一下。</p>*/}
            {/*<p style={{marginTop:"3px"}}>ETH地址:</p>*/}
            {/*<div className="address">{this.state.eth}</div>*/}
            {/*<p>2、BTS资产GDEX.PFC：</p>*/}
            {/*<p style={{fontWeight:400}}>将 BTS 内盘的 GDEX.PFC 转账至 seer.gateway（数字 ID#1.2.974186）转账 memo 备注填：“seer#主网帐号”（双引号不需要填写），即可完成主网 PFC 自动发放，第一次建议小额转账先试一下。</p>*/}
            <p style={{marginTop:"10px"}}>第三方兑换</p>
