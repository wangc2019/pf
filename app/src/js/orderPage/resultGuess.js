  ...
  async getData(){
    ...
    await Apis.instance().db_api().exec("get_seer_room",[this.state.id, 0, 1000]).then(data=>{
      ...
      this.setState({
        ...
        $(".select>ul>li:nth-child("+number+")>span:first-child").css("color","#38D3F4");
        $(".select>ul>li:nth-child("+number+")>span:nth-child(2)").show();
        $(".select>ul>li:nth-child("+number+")>span:nth-child(3)").show();
        $(".select>ul>li:nth-child("+number+")>span:nth-child(2)").css("color","#38D3F4");
        ...
        <div className="guess-content">
          <div className="info">
            <div className="date">
              ...
              <p style={{background:"none",color:"#F13535",border:"1px solid #f13535",borderRadius:"16px",width:'80px',fontSize:'14px'}}>已结束</p>
            </div>
            ...
            <div className="statistics-bottom">
              <div><img src={quan} alt=""/><span>{this.state.data.running_option.total_shares/10000}</span></div>
