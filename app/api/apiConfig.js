...
export const settingsAPIs = {
  ...
  WS_NODE_LIST: [
    ...
    {url: "ws://39.105.189.224/ws", location: {translate: "settings.api_closest"}},
    // {url: "wss://www.seerapi.org", location: "China"}
    {url: "ws://39.105.189.224/ws", location: "China"}
  ],
  DEFAULT_FAUCET: "https://www.seerapi.com",
  TESTNET_FAUCET: "http://106.14.75.91",
  DEFAULT_FAUCET2: "http://faucet.seerchain.org",
  DEFAULT_FAUCET3: "http://f.seerchain.org",
};
